...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        TODO:
            "Method invocation 'getMapAsync' may produce a NullPointerException".
            When this fails, maybe we should in place of the map need to show the
            user that there is an error where the map is, and restrict some app functionality.
    ...
    // Updates map UI after being granted location permissions
    ...
    // Updates the device location and saves the point to the associated route
